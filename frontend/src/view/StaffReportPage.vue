...
.report-main { max-width: 900px; margin: 2rem auto; padding: 0 1.5rem; }
.filter-box {
...
.form-group label { font-size: 0.9rem; color: var(--text-secondary, #94a3b8); }
.form-group input {
  padding: 0.6rem 1rem;
  background: var(--surface-2, #14141f);
  border: 1px solid var(--glass-border, rgba(255,255,255,0.15));
  border-radius: 6px; color: var(--text-primary, #f1f5f9); font-family: inherit;
}
.btn-filter {
  padding: 0.65rem 1.5rem; background: var(--electric, #29bcea); color: #fff;
  border: none; border-radius: 6px; font-weight: 600; cursor: pointer; transition: filter 0.2s;
}
.btn-filter:hover:not(:disabled) { filter: brightness(1.1); }
...
.revenue-icon { background: rgba(16,185,129,0.2); color: #10b981; }
.ticket-icon  { background: rgba(59,130,246,0.2);  color: #3b82f6; }
.checkin-icon { background: rgba(168,85,247,0.2);  color: #a855f7; }
.stat-info { display: flex; flex-direction: column; gap: 0.3rem; }
.stat-label { font-size: 0.85rem; color: var(--text-secondary, #94a3b8); }
.stat-value { font-size: 1.4rem; font-weight: 700; }

.error-msg {
  color: #ef4444; padding: 1rem; background: rgba(239,68,68,0.1); border-radius: 8px; margin-bottom: 2rem;
}
</style>